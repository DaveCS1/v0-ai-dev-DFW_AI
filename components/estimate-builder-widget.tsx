  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <button
        ...
        } transition-all duration-300 mt-4 ml-auto flex items-center gap-3 px-6 py-4 bg-gradient-to-r from-cyan-500 to-cyan-600 text-white font-semibold rounded-2xl hover:from-cyan-400 hover:to-cyan-500 transform hover:scale-105 shadow-2xl shadow-cyan-500/30 hover:shadow-cyan-500/50`}
      >
